...
public class AppointmentController {
    ...
    @Operation(summary = "Get user appointment", description = "get user specific appointment")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Return appointment matched with the user")
    })
    @GetMapping("/mine")
